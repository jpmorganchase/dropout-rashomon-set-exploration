...
def main():
    print("Loading GT...")
    name_2_ann = load_gt('/opt/omniai/work/instance1/jupyter/dataset/coco/annotations/instances_val2017.json')
    ...
    if ARCH == 'yolov3':
        ...
        src_dirs = [
            ...
            'rashomon_maskrcnn/bernoulli_0.0004000',
            'rashomon_maskrcnn/bernoulli_0.0005000',
        ]
