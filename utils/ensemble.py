...
drp_data_filename = [i for i in os.listdir(args.resultroot) if args.dataset + '-' + args.dropoutmethod in i and str(args.drp_nmodel) + '-' + str(args.drp_max_ratio)+'.npz' in i]
